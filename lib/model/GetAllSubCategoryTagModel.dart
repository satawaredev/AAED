...
//
//     final getAllSubCategoryTagModel = getAllSubCategoryTagModelFromJson(jsonString);

import 'dart:convert';

GetAllSubCategoryTagModel getAllSubCategoryTagModelFromJson(String str) => GetAllSubCategoryTagModel.fromJson(json.decode(str));

String getAllSubCategoryTagModelToJson(GetAllSubCategoryTagModel data) => json.encode(data.toJson());

class GetAllSubCategoryTagModel {
  GetAllSubCategoryTagModel({
    this.status,
    this.data,
    this.message,
  });
  ...
  factory GetAllSubCategoryTagModel.fromJson(Map<String, dynamic> json) => GetAllSubCategoryTagModel(
...
List<GetAllSubCategoryTagModel> getAllSubCategoryTagModelFromJson(String str) => List<GetAllSubCategoryTagModel>.from(json.decode(str).map((x) => GetAllSubCategoryTagModel.fromJson(x)));

String getAllSubCategoryTagModelToJson(List<GetAllSubCategoryTagModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
