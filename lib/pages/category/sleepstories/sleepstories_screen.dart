...
class SleepStories extends StatefulWidget {
  @override
  _SleepStoriesState createState() => _SleepStoriesState();
}
...
Widget girdlist(context, List myList) {
 ...
 // final subtitles = ['Jack and Fox','Travelling Truck', 'Calm', 'Adventure','Jack and Fox','Travelling Truck', 'Calm', 'Adventure', 'Calm', 'Adventure'];
//  final categories =[ 'assets/images/SS1.jpg','assets/images/SS2.jpg','assets/images/SS3.jpg','assets/images/SS4.jpg','assets/images/SS5.jpg','assets/images/sleep stories.jpg','assets/images/SS2.jpg','assets/images/sleep stories.png','assets/images/SS3.jpg','assets/images/SS5.jpg'];
  return Container(
    // height: 700,
    child: FutureBuilder(
        ...
        if (snapshot.connectionState == ConnectionState.waiting)
          ...
          return StaggeredGridView.countBuilder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return InkWell(
               onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => Musicplayer2(catId: myList[index].categoryId,sublist: myList,index: index,),));
               },
                child:Container(
